...
glm_enIlI_eIlnI <- intersect(glm_up_selected_genes,union(enIlI,eIlnI))
glm_enIlI_eIlnI_eIlI <- intersect(intersect(glm_up_selected_genes,
                                            union(enIlI,eIlnI)),eIlnI)

RF_enIlI_eIlnI <- intersect(RF_up_selected_genes,union(enIlI,eIlnI))
RF_enIlI_eIlnI_exclude_enIlnI <- setdiff(intersect(RF_up_selected_genes,
                                               union(enIlI,eIlnI)),enIlnI)

glm_notenIlI_eIlnI <- setdiff(glm_up_selected_genes,union(enIlI,eIlnI))
...
MDS_for_selected_genes(dds.ecz = dds.ecz,dds.lym = dds.lym,
                       sel_genes = list(most_genes,
                                        ...
                                        glm_enIlI_eIlnI,
                                        RF_enIlI_eIlnI,
                                        RF_enIlI_eIlnI_exclude_enIlnI,
                                        glm_enIlI_eIlnI_eIlI),
                       titles = c("random 100 genes",
                                  "RF_up_selected_genes",
                                  "glm_up_selected_genes",
                                  "eIlI",
                                  "intersect of glm_enIlI_eIlnI",
                                  "intersect RF_enIlI_eIlnI",
                                  "RF_enIlI_eIlnI_exclude_enIlnI",
                                  "glm_enIlI_eIlnI_eIlI"),
                       include_only_disease = TRUE,measurement = "rpkm",ebg = ebg)

compare_selected_features_barplot(features = glm_notenIlI_eIlnI,dds.lym = dds.lym,
